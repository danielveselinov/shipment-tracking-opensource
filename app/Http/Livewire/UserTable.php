    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->route('carriers.edit', ['carrier' => 'id']),

            Button::make('destroy', 'Delete')
                ->target('')
                ->class('bg-red-500 cursor-pointer text-white p-2 rounded text-sm bg-red-600 hover:bg-red-600')
                ->route('carriers.destroy', ['carrier' => 'id'])
                ->method('delete')
        ];
    }
